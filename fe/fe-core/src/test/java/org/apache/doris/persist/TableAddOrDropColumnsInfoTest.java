...
public class TableAddOrDropColumnsInfoTest {
    ...
    public void testSerialization() throws IOException {
        ...
        TableAddOrDropColumnsInfo tableAddOrDropColumnsInfo2 = GsonUtils.GSON.fromJson(readJson, TableAddOrDropColumnsInfo.class);
        ...
        Assert.assertEquals(tableAddOrDropColumnsInfo1.getIndexSchemaMap(), tableAddOrDropColumnsInfo2.getIndexSchemaMap());
